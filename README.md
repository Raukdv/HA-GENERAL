...
* [Chrome]- Make sure to select a version < 95 for proper work but you can test for higher version.
* [Driver](https://chromedriver.chromium.org/downloads) - Make sure to download and let into the root folder.
